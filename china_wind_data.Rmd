...
write_rds(result, "./data/data_firm_wind_pollution_cone_average_list.rds", compress = "gz")
...
# Combine the results into a single data frame
data_firm_wind_pollution_cone_average_windspeed <- do.call(rbind, result)
```

Saving to RDS file
```{r}
# Save
write_rds(data_firm_wind_pollution_cone_average_windspeed, file = "./data/data_firm_wind_pollution_cone_average_windspeed.rds")
...
# Combine the results into a single data frame
data_firm_wind_pollution_cone_sum_windspeed <- do.call(rbind, result)
```
