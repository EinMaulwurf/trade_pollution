...
data_firm_wind_pollution_no_geom %>%
  left_join(data_firm_wind_pollution_surrounding, by = c("firm_code", "year")) %>%
  left_join(data_firm_wind_pollution_cone_average, by = c("firm_code", "year")) %>%
  left_join(data_firm_wind_pollution_cone_sum, by = c("firm_code", "year")) %>%
  left_join(data_firm_wind_pollution_cone_average_windspeed, by = c("firm_code", "year")) %>%
  left_join(data_firm_wind_pollution_cone_sum_windspeed, by = c("firm_code", "year")) %>%
  write_rds("./data/data_final.rds", compress = "gz")
```